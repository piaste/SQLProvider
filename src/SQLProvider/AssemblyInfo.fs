...
[<assembly: AssemblyVersionAttribute("1.1.36")>]
[<assembly: AssemblyFileVersionAttribute("1.1.36")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.36"
    let [<Literal>] AssemblyFileVersion = "1.1.36"
