...
#if MONO
#else
    //let dotnetSdk = (environVarOrDefault "MSBuildSDKsPath" @"C:/Program Files/dotnet/sdk/2.1.100/Sdks") + @"../Microsoft/Microsoft.NET.Build.Extensions/net461/lib/"
    let dotnetSdk = @"C:\Program Files\dotnet\sdk\2.1.4\Microsoft\Microsoft.NET.Build.Extensions\net461\lib"
